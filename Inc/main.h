...
#define PUL_1_Pin GPIO_PIN_4
#define PUL_1_GPIO_Port GPIOA
#define DR_1_Pin GPIO_PIN_5
#define DR_1_GPIO_Port GPIOA
#define PUL_2_Pin GPIO_PIN_6
#define PUL_2_GPIO_Port GPIOA
#define DR_2_Pin GPIO_PIN_7
#define DR_2_GPIO_Port GPIOA
